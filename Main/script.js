...
function moveToSlide(index) {
    ...
    track.style.transform = `translate3D(${amountToMove}px, 0, 0)`;
...
function moveCarousel2(position, transition = true) {
    ...
    yaTrack.style.transform = `translate3D(${position}px, 0, 0)`;
}
...
function moveCarousel3(position, transition = true) {
    ...
    paninTrack.style.transform = `translate3D(${position}px, 0, 0)`;
}
