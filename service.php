...
// Вставьте этот блок в самом начале файла
header("Access-Control-Allow-Origin: *"); // Разрешить запросы с любого источника
header("Access-Control-Allow-Methods: GET, POST, OPTIONS"); // Разрешить определенные методы
header("Access-Control-Allow-Headers: Content-Type, Authorization"); // Разрешить заголовки

// Если запрос методом OPTIONS, отправьте заголовки и завершите выполнение
if ($_SERVER['REQUEST_METHOD'] === 'OPTIONS') {
    http_response_code(204); // Код успешного ответа без содержимого
    exit(0);
}
 ...
 */ //'eX4KxxGJsE6EZolYtYfozdWM2aQFIlta',
     ...
     */ //'W2w3X27AjC7KO5WzmXYxvXZet4yyzJos'
